                        ...
                        <?php elseif ('checkbox' == $field['type']): ?>
                            ...
                            <div id="<?php echo esc_attr($field['id']); ?>" class="tfb_lb_option themify-checkbox<?php echo $option_js_wrap ?>">
                                <?php foreach ($field['options'] as $opt): ?>
                                    ...
                                    ?>
                                    <input id="<?php echo esc_attr($field['id'] . '_' . $opt['name']); ?>" name="<?php echo esc_attr($field['id']); ?>[]" type="checkbox" class="<?php echo isset($opt['class']) ? $opt['class'] : '' ?> tf-checkbox" value="<?php echo esc_attr($opt['name']); ?>" <?php echo $checkbox_checked . ' ' . $data_el; ?> />
