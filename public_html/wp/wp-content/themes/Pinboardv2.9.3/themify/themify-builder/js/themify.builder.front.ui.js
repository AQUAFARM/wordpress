    ...
    ThemifyPageBuilder = {
                ...
                $(this).sortable({
                    ...
                    stop: function(event, ui) {
                        ...
                        if (self.slidePanelOpen && $('#themify_builder_module_panel').hasClass('slide_builder_module_state_down')) {
                            ...
                            $('#themify_builder_module_panel').find('.slide_builder_module_panel_wrapper').slideDown();
                        }
                    },
        ...
        optionsModule: function(event, isNewModule) {
            ...
            var callback = function(response) {
                ...
                ThemifyBuilderCommon.fontPreview($('#themify_builder_lightbox_container'));
            };
        ...
        moduleSave: function(e) {
            ...
            console.log(temp_appended_data, 'moduleSettings');
            ...
            var self = ThemifyPageBuilder,
                ...
                callback = function() {
                    ...
                    if ('desktop' !== self.activeBreakPoint) {
                        ...
                        console.log(options, 'rowSettings');
                    }
            ...
            var self = ThemifyPageBuilder,
                ...
                callback = function() {
                    ...
                    if ('desktop' !== self.activeBreakPoint) {
                        ...
                        console.log(options, 'columnSettings');
                    }
        ...
        rowSaving: function(e) {
            ...
            console.log(temp_appended_data, 'rowSettings');
        ...
        columnSaving: function(e) {
            ...
            console.log(temp_appended_data, 'columnSettings');
