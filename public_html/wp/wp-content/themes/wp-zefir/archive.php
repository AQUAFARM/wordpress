    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <h1 class="page-title h2">
          <?php
          if (is_day()) {
            echo esc_html__('Daily Archives: ', 'birdwp-theme').'<span>'.get_the_date().'</span>';
          } else if (is_month()) {
            echo esc_html__('Monthly Archives: ', 'birdwp-theme').'<span>'.get_the_date(_x( 'F Y', 'monthly archives date format', 'birdwp-theme')).'</span>';
          } else if (is_year()) {
            echo esc_html__('Yearly Archives: ', 'birdwp-theme').'<span>'.get_the_date( _x( 'Y', 'yearly archives date format', 'birdwp-theme')).'</span>';
          } else {
            esc_html_e('Archives', 'birdwp-theme');
          }
          ?>
        </h1>
      </div>
